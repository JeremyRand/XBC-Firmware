...
#ifndef _AXESCLOSEDQUAD_H
#define _AXESCLOSEDQUAD_H
...
class CAxesClosedQuad : public CAxesOpenQuad, public CRecordAxesQuad
	{
public:
	CAxesClosedQuad(CInterruptCont *pIntCont, unsigned short freq, 
	...
	virtual ~CAxesClosedQuad();

	virtual void Periodic();
	bool Done(unsigned char axis);
	void SetPIDGains(unsigned int pGain, unsigned int iGain, unsigned int dGain);
	void SetPIDGains(unsigned char axis, unsigned int pGain, unsigned int iGain, unsigned int dGain);
	...
	void SyncTrajectory(unsigned char axis);
	  ...
	  int GetGoalPosition(unsigned char axis);
...
protected:
	...
	AxisPosition m_generatedTrajectoryPosition[DAO_MAX_AXES];
	AxisPosition m_generatedTrajectoryPositionUs[DAO_MAX_AXES];

	// PID controller variables   
	int           m_pGain[DAO_MAX_AXES], m_iGain[DAO_MAX_AXES], m_dGain[DAO_MAX_AXES];       
