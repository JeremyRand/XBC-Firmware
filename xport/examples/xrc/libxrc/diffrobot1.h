...
#ifndef _DIFFROBOT1_H
#define _DIFFROBOT1_H
...
class CDiffRobot1 : public CDiffBase, public CXirGpio, public CBluetoothQueue
	{
public:
	CDiffRobot1(unsigned int translationScale, unsigned int rotationScale, int relativeScale=0);
	virtual ~CDiffRobot1();
